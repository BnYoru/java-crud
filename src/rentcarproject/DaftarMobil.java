...
public class DaftarMobil extends javax.swing.JFrame {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        // TODO add your handling code here:
        if ("".equals(idmobil.getText()) || "".equals(namamobil.getText()) ||
                "".equals(merek.getText()) || "".equals(jenismobil.getText()) ||
                    "".equals(tahun.getText()) || "".equals(platnomor.getSelectedItem())){
            JOptionPane.showMessageDialog(this, "Harap Lengkapi Data", "Error", JOptionPane.WARNING_MESSAGE);
        } else {
            
        String checkSQL = "SELECT COUNT(*) FROM datamobil WHERE idakun = '" + idmobil.getText() + "'";
            
        try {
            ResultSet rs = KoneksiDB.executeQuery(checkSQL);
            if (rs.next() && rs.getInt(1) > 0) {
                JOptionPane.showMessageDialog(this, "ID mobil sudah ada. Gunakan ID yang berbeda.", "Error", JOptionPane.WARNING_MESSAGE);
            } else {
                String SQL = "INSERT INTO datamobil (idmobil, namamobil, merek, jenis, tahun, platnomor) "
                + "VALUES('" + idmobil.getText() + "','" + namamobil.getText() + "','"
                + merek.getText() + "','" + jenismobil.getText() + "','"
                + tahun.getText() + "','"
                + platnomor.getSelectedItem() + "')";
